...
<nav>
  ...
  <a href="#contact" class="nav-mobile-cta" data-en="Get a Proposal" data-hr="Zatražite ponudu">Get a Proposal</a>
  <button class="lang-toggle" onclick="toggleLang()" aria-label="Switch language">EN | HR</button>
</nav>
      ...
      <div class="review-property-block">
        ...
        <div class="review-pair">
          <div class="review-card">
            ...
            <div class="review-stars">Superb · 3,016 reviews</div>
          </div>
          <div class="review-card">
            ...
            <div class="review-divider"></div>
            <div class="review-stars">★★★★★ · 3,664 reviews</div>
          </div>
        </div>
      </div>
      <div class="review-property-block">
        ...
        <div class="review-pair">
          <div class="review-card">
            ...
            <div class="review-divider"></div>
            <div class="review-stars">Superb · 367 reviews</div>
          </div>
          <div class="review-card">
            <div class="review-source-row"><div class="review-source-dot"></div><div class="review-source">Google</div></div>
            <div class="review-score">4.7 <span>/ 5</span></div>
            <div class="review-divider"></div>
            <div class="review-stars">★★★★★ · 1,175 reviews</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <form class="contact-form" method="POST" action="#contact" novalidate>
        ...
        <div class="form-row">
          <div class="form-group">
            ...
            <select id="program_type" name="program_type" required>
              ...
              <option value="Creator / Brand Stay">Creator / Brand Stay</option>
              <option value="Wellness / Yoga Retreat">Wellness / Yoga Retreat</option>
              <option value="Active / Sports Camp">Active / Sports Camp</option>
        ...
        <div class="form-group">
          ...
          <input type="text" id="preferred_dates" name="preferred_dates" placeholder="e.g. April\u2013May 2025, flexible">
        </div>
        <div class="form-group">
...
const translations = {
  en: {
    ...
    'nav-mobile-cta': 'Get a Proposal',
    'hero-eyebrow': 'Makarska Riviera · Dalmatia · Croatia',
    'hero-h1': 'Host your program<br>on the <em>Makarska Riviera.</em>',
    'hero-sub': 'A venue for unforgettable stays, retreats and group experiences.<br><br><strong>Medora Auri Hotel & Medora Orbis Camp</strong><br>A beachfront hotel and premium campsite in Podgora.',
    'btn-primary': 'Get a Proposal',
    'btn-outline': 'Explore the venues',
    'intro-label-1': 'Accommodation',
    'intro-text-1': 'Hotel rooms, mobile homes, or a combination. Flexible setups for any group size and format.',
    'intro-label-2': 'Food & Beverage',
    'intro-text-2': 'Reliable catering from daily half board to fully tailored group menus. No coordination required on your end.',
    'intro-label-3': 'Spaces & Logistics',
    'intro-text-3': 'Indoor and outdoor areas ready for use. Activities, transfers and event support all available through us.',
    'venues-tag': 'The Venues',
    'venues-h2': 'Two properties,<br>one organisation.',
    'venues-sub': 'Medora Auri Hotel and Medora Orbis Camp',
    'venues-lead': 'Medora Auri Hotel and Medora Orbis Camp sit side by side in Podgora, on the Makarska Riviera. Use one, the other, or both — depending on what your program needs.',
    'tab-hotel': 'Medora Auri Hotel',
    'tab-camp': 'Medora Orbis Camp',
    'gallery-tag': 'A Look Around',
    'gallery-h2': 'The spaces & facilities',
    'programs-tag': 'What We Host',
    'programs-h2': 'Programs we host.',
    'programs-lead': 'We work with organizers, brands and teams that need a venue that handles the infrastructure, so they can focus on their program.',
    'prog-1-title': 'Creator & Brand Partnerships',
    'prog-1-desc': 'Hosted stays, content production and brand activations. The location works visually and logistically: sea, mountains, outdoor light and facilities that photograph well.',
    'prog-2-title': 'Wellness & Lifestyle Retreats',
    'prog-2-desc': 'Yoga, fitness and recovery retreats with ready-to-use spaces, structured meal options and a calm, natural setting away from the summer crowds.',
    'prog-3-title': 'Active & Sports Camps',
    'prog-3-desc': 'Football camps, dance groups, fitness teams and youth programs. Flexible accommodation, outdoor training areas and full F&B support built in.',
    'prog-4-title': 'Corporate & Team Events',
    'prog-4-desc': 'Offsites, workshops and strategy sessions. Meeting rooms, catering and accommodation in one place, no need to coordinate multiple suppliers.',
    'reviews-tag': 'Guest Ratings',
    'reviews-h2': 'Consistently top-rated<br>on the Riviera.',
    'reviews-lead': 'Rated among the best hotels and campsites on the Makarska Riviera across Google and Booking.com.',
    'location-tag': 'Getting Here',
    'location-h2': 'Podgora, Makarska Riviera,<br>Dalmatia, Croatia.',
    'location-lead': 'Between the Biokovo mountains and the Adriatic, 10 minutes from Makarska town. Straightforward to reach from Split Airport and well connected to major EU cities.',
    'attractions-tag': 'The Region',
    'attractions-h2': 'The surrounding region.',
    'attractions-lead': 'The Makarska Riviera sits at a crossroads of mountains, coast and islands. Day trips make a real difference to the overall program experience.',
    'why-tag': 'Why Medora',
    'why-h2': 'Why organizers<br>choose Medora.',
    'why-lead': 'The main reasons organizers, brands and teams come back.',
    'contact-tag': 'Get in Touch',
    'contact-h2': "Let's build the right package for your group.",
    'contact-lead': "Use this form for retreat planning, brand collaborations, sports camps and corporate offsites. We'll reply with a tailored proposal within 48 hours.",
    'form-submit': 'Request a Proposal',
    'footer-copy': 'Partnership & Group Enquiries',
  },
  hr: {
    'nav-properties': 'Objekti',
    'nav-programs': 'Programi',
    'nav-location': 'Lokacija',
    'nav-why': 'Zašto Medora',
    'nav-cta': 'Zatražite ponudu',
    'nav-mobile-cta': 'Zatražite ponudu',
    'hero-eyebrow': 'Makarská rivijera · Dalmacija · Hrvatska',
    'hero-h1': 'Organizirajte svoj program<br>na <em>Makarskoj rivijeri.</em>',
    'hero-sub': 'Prostor za nezaboravne boravke, retreate i grupna iskustva.<br><br><strong>Medora Auri Hotel & Medora Orbis Camp</strong><br>Hotelski smještaj i premium kamp u Podgori.',
    'btn-primary': 'Zatražite ponudu',
    'btn-outline': 'Pogledajte objekte',
    'intro-label-1': 'Smještaj',
    'intro-text-1': 'Hotelske sobe, mobilne kućice ili kombinacija. Fleksibilni rasporedi za svaku veličinu i format grupe.',
    'intro-label-2': 'Hrana i piće',
    'intro-text-2': 'Pouzdano ugostiteljstvo od dnevnog polupansiona do potpuno prilagođenih grupnih menija.',
    'intro-label-3': 'Prostori i logistika',
    'intro-text-3': 'Unutarnji i vanjski prostori spremni za korištenje. Aktivnosti, transferi i organizacijska podrška dostupni su putem nas.',
    'venues-tag': 'Objekti',
    'venues-h2': 'Dva objekta,<br>jedna organizacija.',
    'venues-sub': 'Medora Auri Hotel i Medora Orbis Camp',
    'venues-lead': 'Medora Auri Hotel i Medora Orbis Camp nalaze se jedan pored drugog u Podgori, na Makarskoj rivijeri. Koristite jedan, drugi ili oba — ovisno o potrebama vašeg programa.',
    'tab-hotel': 'Medora Auri Hotel',
    'tab-camp': 'Medora Orbis Camp',
    'gallery-tag': 'Pogledajte',
    'gallery-h2': 'Prostori i sadržaji',
    'programs-tag': 'Što nudimo',
    'programs-h2': 'Programi koje organiziramo.',
    'programs-lead': 'Surađujemo s organizatorima, brendovima i timovima kojima je potreban prostor koji se brine o infrastrukturi — kako bi se oni mogli fokusirati na program.',
    'prog-1-title': 'Kreatori i brendovi',
    'prog-1-desc': 'Organizirani boravci, produkcija sadržaja i brand aktivacije. Lokacija funkcionira vizualno i logistički: more, planine, vanjsko svjetlo i sadržaji koji dobro izgledaju na fotografijama.',
    'prog-2-title': 'Wellness i lifestyle retreati',
    'prog-2-desc': 'Yoga, fitness i retreati oporavka s prostorima spremnim za korištenje, strukturiranim obrocima i mirnim, prirodnim okruženjem izvan ljetnih gužvi.',
    'prog-3-title': 'Aktivni kampovi i sport',
    'prog-3-desc': 'Nogometni kampovi, plesne grupe, fitness timovi i programi za mlade. Fleksibilan smještaj, vanjske zone za trening i puna F&B podrška.',
    'prog-4-title': 'Korporativni eventi i timovi',
    'prog-4-desc': 'Offsiteovi, radionice i strateške sesije. Sobe za sastanke, catering i smještaj na jednom mjestu — bez koordinacije više dobavljača.',
    'reviews-tag': 'Ocjene gostiju',
    'reviews-h2': 'Dosljedno vrhunski ocijenjeni<br>na Rivijeri.',
    'reviews-lead': 'Ocijenjeni među najboljim hotelima i kampovima na Makarskoj rivijeri na Googleu i Booking.com-u.',
    'location-tag': 'Kako doći',
    'location-h2': 'Podgora, Makarská rivijera,<br>Dalmacija, Hrvatska.',
    'location-lead': 'Između planine Biokovo i Jadranskog mora, 10 minuta od Makarske. Jednostavan dolazak iz Splitske zračne luke i dobra povezanost s glavnim europskim gradovima.',
    'attractions-tag': 'Regija',
    'attractions-h2': 'Okolica.',
    'attractions-lead': 'Makarská rivijera smještena je na raskrižju planina, mora i otoka. Izleti značajno obogaćuju ukupni doživljaj programa.',
    'why-tag': 'Zašto Medora',
    'why-h2': 'Zašto organizatori<br>biraju Medoru.',
    'why-lead': 'Glavni razlozi zbog kojih se organizatori, brendovi i timovi vraćaju.',
    'contact-tag': 'Kontaktirajte nas',
    'contact-h2': 'Izgradimo pravi paket za vašu grupu.',
    'contact-lead': 'Koristite ovaj obrazac za planiranje retreata, brand suradnje, sportske kampove i korporativne evente. Odgovorit ćemo s prilagođenom ponudom u roku 48 sati.',
    'form-submit': 'Zatražite ponudu',
    'footer-copy': 'Upiti za partnerstva i grupe',
  }
};
...
function toggleLang() {
  ...
  btn.textContent = currentLang === 'en' ? 'EN | HR' : 'HR | EN';

  // Nav links
  const navLinks = document.querySelectorAll('.nav-links a');
  const keys = ['nav-properties','nav-programs','nav-location','nav-why','nav-cta'];
  navLinks.forEach((a, i) => { if (t[keys[i]]) a.textContent = t[keys[i]]; });

  // Mobile CTA
  const mobileCta = document.querySelector('.nav-mobile-cta');
  if (mobileCta) mobileCta.textContent = t['nav-mobile-cta'];

  // Hero
  setHTML('.hero-eyebrow', t['hero-eyebrow']);
  setHTML('.hero h1', t['hero-h1']);
  setHTML('.hero-sub', t['hero-sub']);
  setHTML('.btn-primary', t['btn-primary']);
  setHTML('.btn-outline', t['btn-outline']);

  // Intro strip
  const introLabels = document.querySelectorAll('.intro-label');
  const introTexts = document.querySelectorAll('.intro-text');
  [1,2,3].forEach((n,i) => {
    if (introLabels[i]) introLabels[i].textContent = t['intro-label-'+n];
    if (introTexts[i]) introTexts[i].textContent = t['intro-text-'+n];
  });

  // Venues
  setText('.section-tag', t['venues-tag'], 0);
  setHTML('[id="properties"] ~ div h2', t['venues-h2']);
  const venueSub = document.querySelectorAll('.section-full-inner p')[0];
  if (venueSub) venueSub.textContent = t['venues-sub'];

  // Venue tabs
  const tabs = document.querySelectorAll('.venue-tab');
  if (tabs[0]) tabs[0].textContent = t['tab-hotel'];
  if (tabs[1]) tabs[1].textContent = t['tab-camp'];

  // Gallery
  setText('.section-tag', t['gallery-tag'], 2);
  setText('h2', t['gallery-h2'], 2);

  // Programs
  setText('.section-tag', t['programs-tag'], 3);
  setText('h2', t['programs-h2'], 3);
  const progDescs = document.querySelectorAll('.program-desc');
  const progTitles = document.querySelectorAll('.program-title');
  [1,2,3,4].forEach((n,i) => {
    if (progTitles[i]) progTitles[i].textContent = t['prog-'+n+'-title'];
    if (progDescs[i]) progDescs[i].textContent = t['prog-'+n+'-desc'];
  });

  // Reviews
  const reviewsSection = document.querySelector('.reviews-section');
  if (reviewsSection) {
    reviewsSection.querySelector('.section-tag').textContent = t['reviews-tag'];
    setHTML2(reviewsSection.querySelector('h2'), t['reviews-h2']);
    reviewsSection.querySelector('.lead').textContent = t['reviews-lead'];
  }

  // Location
  setText('.section-tag', t['location-tag'], 4);
  setText('h2', t['location-h2'], 4);

  // Attractions
  const attSection = document.querySelector('.attractions-inner');
  if (attSection) {
    attSection.querySelector('.section-tag').textContent = t['attractions-tag'];
    attSection.querySelector('h2').textContent = t['attractions-h2'];
    attSection.querySelector('.lead').textContent = t['attractions-lead'];
  }

  // Why
  const whySection = document.querySelector('#why');
  if (whySection) {
    whySection.querySelector('.section-tag').textContent = t['why-tag'];
    setHTML2(whySection.querySelector('h2'), t['why-h2']);
    whySection.querySelector('.lead').textContent = t['why-lead'];
  }

  // Contact
  const contactSection = document.querySelector('.contact-section');
  if (contactSection) {
    contactSection.querySelector('.section-tag').textContent = t['contact-tag'];
    contactSection.querySelector('h2').textContent = t['contact-h2'];
    contactSection.querySelector('.lead').textContent = t['contact-lead'];
...
function setText(selector, text, index) {
  ...
  if (els[index]) els[index].innerHTML = text;
}
</script>
</body>
</html>
